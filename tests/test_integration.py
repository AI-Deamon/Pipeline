...
def test_integration_v1(mock_celery_task):
    ...
    # Scan starts in CREATED state (transitions to RUNNING when Jenkins confirms)
    ...
    # Still CREATED until Jenkins callback confirms build started
    assert scan_state == "CREATED"
